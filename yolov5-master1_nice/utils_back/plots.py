...
class Annotator:
    ...
    def add_num(self, num):
        cv2.putText(self.im, str(num.cpu().numpy()), (50, 50), 0, self.lw / 3, (255, 255, 255))
...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=1920, max_subplots=16):
    ...
    # annotator.text((150, 150), text=len(targets), txt_color=(220, 220, 220))
    annotator.add_num(len(targets))
    for i in range(i + 1):
        x, y = int(w * (i // ns)), int(h * (i % ns))  # block origin
